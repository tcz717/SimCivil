...
namespace SimCivil.Orleans.Grains.Service
{
    ...
    /// </summary>
    [AutoService(ServiceLifetime.Transient, ServiceType = typeof(SimplexNoiseGenerator))]
    public class SimplexNoiseGenerator
    {
        ...
        public float[] Calc1D(int width, int widthOffset = 0, float scale = 1)
        {
        ...
        public float[,] Calc2D(int width, int height, int widthOffset = 0, int heightOffset = 0, float scale = 1)
        {
        ...
        public float[,,] Calc3D(int width, int height, int length, int widthOffset = 0, int heightOffset = 0, int lengthOffset = 0, float scale = 1)
        {
